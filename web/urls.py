...
from .views import (
    ...
    nll_schedule, nll_schedule_debug, cache_stats, CustomPasswordResetView, CustomPasswordResetDoneView, CustomPasswordResetConfirmView, CustomPasswordResetCompleteView,
...
urlpatterns = [
    ...
    path("nll-schedule/debug/", nll_schedule_debug, name="nll_schedule_debug"),
